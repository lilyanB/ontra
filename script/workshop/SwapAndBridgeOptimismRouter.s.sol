...
import {SwapAndBridgeOptimismRouter, IL1StandardBridge} from "../../src/workshop/SwapAndBridgeOptimismRouter.sol";
    ...
    function run() public {
        ...
        poolSwapAndBridgeOptimism.swap{value: 0.001 ether}(
            ...
            SwapAndBridgeOptimismRouter.SwapSettings({
                    bridgeTokens: true, recipientAddress: vm.addr(deployerPrivateKey)
                }),
            ZERO_BYTES
        );
