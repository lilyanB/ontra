...
export function useUserOrders() {
  ...
  const { data: shares0Long, refetch: refetch0Long } = useReadContract({
    ...
    args: address && epoch0Long !== undefined ? [address, poolId, 0, true, epoch0Long] : undefined,
  ...
  const { data: shares0Short, refetch: refetch0Short } = useReadContract({
    ...
    abi: ONTRA_V2_HOOK_ABI,
    functionName: "getUserShares",
    args: address && epoch0Short !== undefined ? [address, poolId, 0, false, epoch0Short] : undefined,
  ...
  const { data: shares1Long, refetch: refetch1Long } = useReadContract({
    ...
    abi: ONTRA_V2_HOOK_ABI,
    functionName: "getUserShares",
    args: address && epoch1Long !== undefined ? [address, poolId, 1, true, epoch1Long] : undefined,
  ...
  const { data: shares1Short, refetch: refetch1Short } = useReadContract({
    ...
    abi: ONTRA_V2_HOOK_ABI,
    functionName: "getUserShares",
    args: address && epoch1Short !== undefined ? [address, poolId, 1, false, epoch1Short] : undefined,
  ...
  const { data: shares2Long, refetch: refetch2Long } = useReadContract({
    ...
    abi: ONTRA_V2_HOOK_ABI,
    functionName: "getUserShares",
    args: address && epoch2Long !== undefined ? [address, poolId, 2, true, epoch2Long] : undefined,
  ...
  const { data: shares2Short, refetch: refetch2Short } = useReadContract({
    ...
    abi: ONTRA_V2_HOOK_ABI,
    functionName: "getUserShares",
    args: address && epoch2Short !== undefined ? [address, poolId, 2, false, epoch2Short] : undefined,
  ...
  const { data: pool0Long } = useReadContract({
    ...
    query: { enabled: epoch0Long !== undefined && shares0Long !== undefined && Number(shares0Long) > 0 },
  });
  ...
  const { data: pool0Short } = useReadContract({
    ...
    query: { enabled: epoch0Short !== undefined && shares0Short !== undefined && Number(shares0Short) > 0 },
  });
  ...
  const { data: pool1Long } = useReadContract({
    ...
    query: { enabled: epoch1Long !== undefined && shares1Long !== undefined && Number(shares1Long) > 0 },
  });
  ...
  const { data: pool1Short } = useReadContract({
    ...
    query: { enabled: epoch1Short !== undefined && shares1Short !== undefined && Number(shares1Short) > 0 },
  });
  ...
  const { data: pool2Long } = useReadContract({
    ...
    query: { enabled: epoch2Long !== undefined && shares2Long !== undefined && Number(shares2Long) > 0 },
  });
  ...
  const { data: pool2Short } = useReadContract({
    ...
    query: { enabled: epoch2Short !== undefined && shares2Short !== undefined && Number(shares2Short) > 0 },
  });
  ...
  const userOrders = useMemo(() => {
    ...
    const positions = [
      { tier: 0 as const, isLong: true, epoch: epoch0Long, shares: shares0Long, pool: pool0Long },
      { tier: 0 as const, isLong: false, epoch: epoch0Short, shares: shares0Short, pool: pool0Short },
      { tier: 1 as const, isLong: true, epoch: epoch1Long, shares: shares1Long, pool: pool1Long },
      { tier: 1 as const, isLong: false, epoch: epoch1Short, shares: shares1Short, pool: pool1Short },
      { tier: 2 as const, isLong: true, epoch: epoch2Long, shares: shares2Long, pool: pool2Long },
      { tier: 2 as const, isLong: false, epoch: epoch2Short, shares: shares2Short, pool: pool2Short },
    ];
    ...
    return orders;
  }, [epoch0Long, epoch0Short, epoch1Long, epoch1Short, epoch2Long, epoch2Short, 
      shares0Long, shares0Short, shares1Long, shares1Short, shares2Long, shares2Short,
      pool0Long, pool0Short, pool1Long, pool1Short, pool2Long, pool2Short]);
